...
map_df$Variable <- factor(map_df$Variable, 
   ...
   #scale_fill_gradientn(colours=c("#533600", "#966D12", "#CBA46C", "#EED5B8", "#F6F6F6", "#A9E4DC", "#2EBEB0", "#00897B", "#004B40"), limits=c(-35,35), breaks=c(-35,-15,0,15,35)) + #opt1
        scale_fill_gradientn(colours=c("#533600", "#966D12", "#CBA46C",  "#F6F6F6", "#2EBEB0", "#00897B", "#004B40"), limits=c(-35,35),  breaks=c(-35,-15,0,15,35)) + #opt2
...
###Plot####
    ...
    print(gg1 + geom_tile(data=map_df_all, aes(x=Longitude, y=Latitude, fill=Effect), alpha=0.8) + #scale_fill_gradient2(midpoint=0, low=lowcolor, mid=midcolor, high=highcolor, limits=c(summary(map_df_all$Effect)[1],summary(map_df_all$Effect)[6]), name="Yield Change (%)") + 
      #scale_fill_gradientn(colours=c("#533600", "#966D12", "#CBA46C", "#EED5B8", "#F6F6F6", "#A9E4DC", "#2EBEB0", "#00897B", "#004B40"), limits=c(-65,65), breaks=c(-65,-25,0,25,65)) + #opt1
        scale_fill_gradientn(colours=c("#533600", "#966D12", "#CBA46C",  "#F6F6F6", "#2EBEB0", "#00897B", "#004B40"), limits=c(-65,65),  breaks=c(-65,-25,0,25,65)) + #opt2
    ...
    print(gg1 + geom_tile(data=map_change, aes(x=Longitude, y=Latitude, fill=Effect), alpha=0.8) + #scale_fill_gradient2(midpoint=0, low=lowcolor, mid=midcolor, high=highcolor, limits=c(summary(map_change$Effect)[1],summary(map_change$Effect)[6]), name="Yield Change (%)") +
      #scale_fill_gradientn(colours=c("#004B40", "#00897B", "#2EBEB0", "#F6F6F6", "#CBA46C", "#966D12", "#533600"), limits=c(-100,100), breaks=c(-100,0,100)) +
      #scale_fill_gradientn(colours=c("#533600", "#966D12", "#CBA46C", "#EED5B8", "#F6F6F6", "#A9E4DC", "#2EBEB0", "#00897B", "#004B40"), limits=c(-65,65), breaks=c(-65,-25,0,25,65)) + #opt1
        scale_fill_gradientn(colours=c("#533600", "#966D12", "#CBA46C",  "#F6F6F6", "#2EBEB0", "#00897B", "#004B40"), limits=c(-65,65),  breaks=c(-65,-25,0,25,65)) + #opt2
      ggtitle(paste0("RCP 4.5")) +
